  ...
  return (
    <section className="about bg-white">
        <div className="container-left ">
          <div className="img1">
            <img src="./assets/images/klin.jpg" alt="" className="object-cover" />
          </div>
          <div className="img2">
            <img src="./assets/images/programmer-working.jpg" alt="" className="object-cover"/>
          </div>
        ...
        <div className="container-right">
          <div>
            ...
            <div className="about-txt">
              ...
              sunt maiores quos culpa obcaecati magnam itaque cumque?
              Asperiores, dignissimos eveniet.
            </div>
            <div className="special-txt">
              "Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Pariatur modi aliquam adipisci, optio nostrum assumenda?"
            </div>
          </div>
          <div>
            ...
            <div className="feedback">
              <img src="./assets/images/julio.jpg" alt="" className="img1 object-cover" />
              <img src="./assets/images/young.jpg" alt="" className="img2 object-cover" />
              <img
                src="./assets/images/software-developer-at-office.jpg"
                alt=""
                className="img3 object-cover"
              />
              <div className="num">
