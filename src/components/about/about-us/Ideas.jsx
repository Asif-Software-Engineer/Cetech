  ...
  return (
    <section className="ideas">
      <div className="overlay flex align-center justify-center">
        <div className="">
          <div className="mx-[2rem] lg:mx-[5rem] py-10 md:py-16 lg:py-20 text-white font-kanit w-full max-w-[80%] md:max-w-[42%]">
            <h2 className="text-6 md:text-10 lg:text-13 font-semibold">
              BRING YOUR IDEAS
            </h2>
            <div className="text-30 md:text-45 lg:text-45 xl:text-55 2xl:text-55 font-bold mt-8 animate-slide-up">
